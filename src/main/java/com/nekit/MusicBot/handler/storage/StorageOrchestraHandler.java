...
public class StorageOrchestraHandler implements Handler {

    private final FileService fileService;

    @Override
    public StateBot getCurrentState() {
        return StateBot.STORAGE_ORCHESTRA;
    }
    ...
    public Object handle(Message message) {
        Map<Long, FileEntity> map = fileService.getFileMap(FileLesson.ORCHESTRA_FILE);

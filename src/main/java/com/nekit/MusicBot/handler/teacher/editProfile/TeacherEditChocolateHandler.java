...
public class TeacherEditChocolateHandler implements Handler {

    private final UserService userService;

    @Override
    public StateBot getCurrentState() {
        return StateBot.TEACHER_EDIT_CHOCOLATE;
    }

    @Override
    public BotApiMethod<?> handle(Message message) {
        userService.updateUserState(message.getChatId(), StateBot.TEACHER_EDIT_CHOCOLATE_SUCCESSFULLY);

...
public class TeacherEditFioHandler implements Handler {

    private final UserService userService;

    @Override
    public StateBot getCurrentState() {
        return StateBot.TEACHER_EDIT_FIO;
    }

    @Override
    public BotApiMethod<?> handle(Message message) {
        userService.updateUserState(message.getChatId(), StateBot.TEACHER_EDIT_FIO_SUCCESSFULLY);

...
public enum StateBot {
    ...
    FILE_LOAD("Выберите раздел для загрузки: ", "Загрузить файл"),
    FILE_LOAD_CHOIR("Загрузите сюда фото/видео/документ/аудио для хора", "Хор"),
    FILE_LOAD_CHOIR_NAME("Файл пришел, отлично, теперь для файла надо написать название, которое будут видеть пользователи:", null),
    FILE_LOAD_CHOIR_SUCCESSFULLY("""
            Файл для хора успешно загружен.\s

            Найти вы его сможете в главном меню в разделе 'Материалы сессии'""", "Взять из названия загруженного файла"),
    FILE_LOAD_ORCHESTRA("Загрузите сюда фото/видео/документ/аудио для оркестра", "Оркестр"),
    FILE_LOAD_ORCHESTRA_NAME("Файл пришел, отлично, теперь для файла надо написать название, которое будут видеть пользователи:", null),
    FILE_LOAD_ORCHESTRA_SUCCESSFULLY("""
            Файл для оркестра успешно загружен.\s

            Найти вы его сможете в главном меню в разделе 'Материалы сессии'""", "Взять из названия загруженного файла"),
    FILE_LOAD_SOLFEGGIO("Загрузите сюда фото/видео/документ/аудио для сольфеджио", "Сольфеджио"),
    FILE_LOAD_SOLFEGGIO_NAME("Файл пришел, отлично, теперь для файла надо написать название, которое будут видеть пользователи:", null),
    FILE_LOAD_SOLFEGGIO_SUCCESSFULLY("""
            Файл для сольфеджио успешно загружен.\s

            Найти вы его сможете в главном меню в разделе 'Материалы сессии'""", "Взять из названия загруженного файла"),
    FILE_LOAD_OTHER("Загрузите сюда фото/видео/документ/аудио в папку 'Другие файлы'", "Другое"),
    FILE_LOAD_OTHER_NAME("Файл пришел, отлично, теперь для файла надо написать название, которое будут видеть пользователи:", null),
    FILE_LOAD_OTHER_SUCCESSFULLY("""
            Файл успешно загружен 'Другие файлы'.\s

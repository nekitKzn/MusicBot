...
public enum StateBot {
    ...
    ABOUT_BOT("""
            ...
            Этот бот поможет Вам узнать некоторую информацию о Сессии, преподавателях и организаторов, а также задать интересующий Вас вопрос о музыкальном служении.
